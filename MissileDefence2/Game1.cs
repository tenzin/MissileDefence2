...
namespace MissileDefence2.MacOS
{
	...
	public class Game1 : Game
	{
		...
		public static int LEVEL_1_WAVE = 3;
		public static int LEVEL_2_WAVE = 3;
		public static int LEVEL_3_WAVE = 3;
        
		//Threat speed for each level
		public static float LEVEL1_BASE_SPEED = 0.7f;
		...
		public static int CITY_HIT_POINT = 7;
		...
		private void ResetLevel1Threats()
		{
			...
			for (int i = 0; i < LEVEL_1_THREAT_COUNT; i++)
			{
				if (level1ThreatList[i].visible == false)
				{
					...
					level1ThreatList[i].setDeltaSpeed(new Vector2(0, LEVEL1_BASE_SPEED + (float)random.NextDouble()));
		...
		private void DrawHighScore()
		{
            ...
            {
				spriteBatch.DrawString(font, "YOUR SCORE: " + gameScore, new Vector2(10, 30), Color.White);
                spriteBatch.DrawString(font, "HIGH SCORE: " + highScore, new Vector2(10, 50), Color.White);
            }
			if(gameScore > highScore)
			{
				spriteBatch.DrawString(font, "YOU BEAT THE HIGH SCORE!!!", new Vector2(10, 30), Color.White);
				spriteBatch.DrawString(font, "YOUR SCORE: " + gameScore, new Vector2(10, 50), Color.White);
			}
		}
